...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            version=os.getenv("AGENT_TRUST_VERSION", cls.version),
            ...
            auth_mode=os.getenv("AGENT_TRUST_AUTH_MODE", cls.auth_mode).strip().lower(),
            workspace_id=os.getenv("AGENT_TRUST_WORKSPACE_ID", cls.workspace_id).strip() or cls.workspace_id,
            ...
            provider_timeout_seconds=float(os.getenv("AGENT_TRUST_PROVIDER_TIMEOUT", cls.provider_timeout_seconds)),
            max_request_bytes=int(os.getenv("AGENT_TRUST_MAX_REQUEST_BYTES", cls.max_request_bytes)),
            retention_days=int(os.getenv("AGENT_TRUST_RETENTION_DAYS", cls.retention_days)),
        )
